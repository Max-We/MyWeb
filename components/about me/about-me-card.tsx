...
export default function AboutMeCard(props: AboutMeCardProps) {
  return (
    <div className="mb-7 w-full rounded-xl border p-3 text-center shadow delay-75 duration-100 hover:-translate-y-1 hover:shadow-xl dark:border-gray-700 dark:bg-gray-800 lg:p-5">
